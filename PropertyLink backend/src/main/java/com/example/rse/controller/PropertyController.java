...
public class PropertyController {
    ...
    public ResponseEntity<?> createProperty(
        ...
        if (user.isPresent() && "seller".equalsIgnoreCase(user.get().getRole())) {
            try {
    ...
    public ResponseEntity<?> viewProperties(@RequestParam String username) {
        ...
        if (user.isPresent() && ("client".equalsIgnoreCase(user.get().getRole()) || "seller".equalsIgnoreCase(user.get().getRole()))) {
